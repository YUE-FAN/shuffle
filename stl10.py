"""
Training script for STL10

10 classes: airplane, bird, car, cat, deer, dog, horse, monkey, ship, truck.
Images are 96x96 pixels, color.
500 training images, 800 test images per class

Hyper-parameters should be chosen by 10-fold CV using the pre-defined 10 folds in fold_indices.txt

Usage:
python stl10.py -a vgg16 --dataset stl10 --depth 110 --epochs 60 --schedule 50 --gamma 0.1 --wd 1e-4 --checkpoint checkpoints/stl10/vgg16_60 --gpu-id 1
