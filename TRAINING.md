python cifar.py -a resnet50 --dataset cifar100 --depth 110 --epochs 100 --schedule 50 75 --gamma 0.1 --wd 1e-4 --checkpoint /data/users/yuefan/fanyue/dconv/checkpoints/dell/del --gpu-id 2
...
python cifar.py -a resnet50 --dataset cifar100 --depth 110 --epochs 60 --schedule 50 --gamma 0.1 --wd 1e-4 --checkpoint /data/users/yuefan/fanyue/dconv/checkpoints/cifar100/dconv_cos_resnet50_stage_5_123_win5_60 --gpu-id 2
python cifar.py -a vgg16 --dataset cifar100 --depth 110 --epochs 60 --schedule 50 --gamma 0.1 --wd 1e-4 --checkpoint /data/users/yuefan/fanyue/dconv/checkpoints/del/dconv_daishare_vgg16_42_winu_601 --gpu-id 1

python stl10.py -a vgg16 --dataset stl10 --depth 110 --epochs 60 --schedule 50 --gamma 0.1 --wd 1e-4 --checkpoint /data/users/yuefan/fanyue/dconv/checkpoints/stl10/dconv_none_vgg16_42_winu_60 --gpu-id 0
...
#### ResNet-50
```
python cifar.py -a resnet50 --dataset cifar100 --depth 110 --epochs 100 --schedule 50 75 --gamma 0.1 --wd 1e-4 --checkpoint checkpoints/cifar100/resnet-50 --gpu-id 0 
```
