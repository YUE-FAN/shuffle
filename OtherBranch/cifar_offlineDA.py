'''
This is to test if offline random flipping gives different result to that of on the fly. The dataset was first created
from the original cifar100 dataset, it is now saved under /BS/yfan/work/data/cifar100_fp.
'''
...
from offlineDA import CIFAR10, CIFAR100
...
def main():
    ...
    trainset = dataloader(root='/BS/yfan/work/data/cifar100_fp', train=True, download=False, transform=transform_train)
    trainloader = data.DataLoader(trainset, batch_size=args.train_batch, shuffle=True, num_workers=args.workers)

    testset = dataloader(root='/BS/yfan/work/data/cifar100_fp', train=False, download=False, transform=transform_test)
