...
class Dconv_cshuffle(nn.Module):
    ...
    def __init__(self, inplane, outplane, kernel_size, stride, padding):
        ...
        self.dilated_conv = nn.Conv2d(inplane, outplane, kernel_size=kernel_size, stride=stride, padding=padding, bias=False)
    ...
    def forward(self, x):
        ...
        x_offset[:, :, :, :] = x[:, perm.long()].view(x_shape[0], x_shape[2], x_shape[3], x_shape[1]).permute(0, 3, 1, 2)
