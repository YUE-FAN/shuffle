...
class MobileNetV2_1x1LMP(nn.Module):
    def __init__(self, num_classes, layer):
        ...
        if layer > 20:
            ...
            layers.append(nn.Sequential(block1x1(16, 24, 2, 6), nn.MaxPool2d(2, 2)))
        if layer > 21:
            layers.append(block(24, 24, 1, 6))
        else:
            layers.append(block1x1(24, 24, 1, 6))
        ...
        if layer > 30:
            ...
            layers.append(nn.Sequential(block1x1(24, 32, 2, 6), nn.MaxPool2d(2, 2)))
        if layer > 31:
            layers.append(block(32, 32, 1, 6))
        else:
            layers.append(block1x1(32, 32, 1, 6))
        ...
        if layer > 40:
            ...
            layers.append(nn.Sequential(block1x1(32, 64, 2, 6), nn.MaxPool2d(2, 2)))
        if layer > 41:
            layers.append(block(64, 64, 1, 6))
        else:
            layers.append(block1x1(64, 64, 1, 6))
