    ...
    def __init__(self, height, width, inplane, outplane, win_range=100, kernel_size=3):
        ...
        for key_i in range(self.h):
            for key_j in range(self.w):
                ...
                self.sample_dict[(key_i, key_j)] = torch.tensor(random.sample(idx_list, kernel_size * kernel_size)).cuda(cuda_number)
...
class Dconv_rand(nn.Module):
    ...
    def __init__(self, inplane, outplane):
        ...
        print('Dconv_rand is used')
        # TODO: support convolutions with any kernel size
        self.dilated_conv = nn.Conv2d(inplane, outplane, kernel_size=3, stride=1, padding=1, bias=False)
...
class Dconv_shuffleall(nn.Module):
    ...
    def __init__(self, inplane, outplane):
        ...
        print('Dconv_shuffleall is used')
        # TODO: support convolutions with any kernel size
        self.dilated_conv = nn.Conv2d(inplane, outplane, kernel_size=3, stride=1, padding=1, bias=False)
