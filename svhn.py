"""
Training script for SVHN

10 classes
Images are 32x32 pixels, color image.
There are 73,257 images in the training set, 26,032 images in the test set

Usage:
python svhn.py -a vgg16 --dataset svhn --depth 110 --epochs 60 --schedule 50 --gamma 0.1 --wd 1e-4 --checkpoint checkpoints/svhn/vgg16_60 --gpu-id 1
