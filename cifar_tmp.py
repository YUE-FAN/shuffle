'''
model have 2 layer parameters, llayer and hlayer
'''
...
from models.cifar.vgg16_tmp import *
...
parser.add_argument('--llayer', type=int)
parser.add_argument('--hlayer', type=int)
...
def main():
    ...
    if args.arch.endswith('vgg16_1x1dense'):
        model = vgg16_1x1dense(
