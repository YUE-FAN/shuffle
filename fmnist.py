...
Usage:
python mnist.py -a vgg16 --dataset fasion-mnist --depth 110 --epochs 60 --schedule 50 --gamma 0.1 --wd 1e-4 --checkpoint checkpoints/stl10/vgg16_60 --gpu-id 1

TODO: 1. test different random crop function     2. add dropout layer
...
# Datasets
parser.add_argument('-d', '--dataset', default='fashion-mnist', type=str)
...
# Validate dataset
assert args.dataset == 'fashion-mnist'
...
def main():
    ...
    testset = dataloader(root='/data/users/yuefan/fanyue/dconv/data', train=False, download=True, transform=transform_test)
